...
import 'package:quran/widget/quran_terjemahan.dart';

import '../viewmodel/quran_model.dart';
import '../widget/quran_surah.dart';
// import '../screen/ayats_list.dart' as ayatSajadah;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Aslam - Al-Qur'an"),
          bottom: TabBar(
            tabs: [
              Tab(
              ...
              child: firstLoad
                  ...
                  : Consumer<QuranData>(
                      ...
                      builder: (ctx, data, _) => ListView.builder(
                        controller:
                            controller, //SET CONTROLLER YANG DIBUAT DIAWAL
